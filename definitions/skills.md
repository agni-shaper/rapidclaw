...
|---|---|---|---|---|
| `growth-marketing` | **LIVE (Phase 2 + plist cutover 2026-06-30)** — loaded by marketing-recon, marketing-morning, marketing-evening, gtm-weekly-pick, biweekly-shoutouts (all in cron). 4 reference files: 3 brand strategies + accounts + rotation + config pointer. | Distribution / growth ops across all 3 products. Per-brand strategies + per-account references. | `marketing/` directory + `marketing-morning`/`evening`/`recon` routines body | `#marketing-automation`, `#marketing` |
