...
| `bug-tracking` | **LIVE-VIA-COMPOSITION (Phase 2)** — referenced by task-management when bug-shaped signals are detected; no standalone routine yet. Stays md-only (`sites/tasks/intake/bugs.md` in the tasks repo); empty `bug_reports` sqlite table dropped 2026-06-30 to avoid splitting the bug DB across two repos. | 12:15 scan feeds `sites/tasks/intake/bugs.md`. | (currently part of tasks-cleanup) | `#rapidnative-coach`, `#tasks` |
