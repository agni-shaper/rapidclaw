...
- If a teammate isn't in the `marketing/team.md` "Active" list (or its skill-side mirror at `.claude/skills/growth-marketing/references/accounts.md`), they don't get a slate. To onboard a new crew member, edit BOTH files until the legacy `marketing/` is deleted in a future commit.
